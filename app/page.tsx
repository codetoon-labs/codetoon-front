  ...
  return <>
    <section className="flex min-h-screen items-center justify-center bg-[#f5fbfe] font-sans dark:bg-black">
        ...
        <div className="flex flex-col items-center z-9 text-center relative top-[100px] gap-7">
            ...
            <div>
                <Link href='/'>
                    <button className="cursor-pointer bg-[#0d71ba] px-5 py-2 rounded-[8px] font-bold text-[18px] flex items-center justify-center gap-[10px] text-[#F4D315] hover:shadow-[0_0_15px_#F5D72C] transition-shadow duration-300">
