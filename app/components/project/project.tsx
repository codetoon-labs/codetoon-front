        ...
        <div>
            <div className="2xl:px-0 lg:sm:px-[48px] z-10">
                ...
                <div className="my-[40px]">
                    ...
                    {!loading && !error && data?.projects?.data.map((project, index) => {
                        ...
                        return (
                            <div key={project.id} className={`flex ${isEven ? 'flex-col lg:flex-row' : 'flex-col-reverse lg:flex-row'} gap-[16px] lg:items-center ${index > 0 ? 'mt-[48px]' : ''}`}>
                                {isEven ? (
                                    <>
                                        {projectImageSection}
